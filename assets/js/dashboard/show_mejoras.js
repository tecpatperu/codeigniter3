...
(function(){
  ...
  $('.view_detailmejora').on('mousedown', function(e) {

    $(this).click(function(){return false;});
      $.ajax({
        type: 'ajax',
          url : '/codeigniter3/mejoras/editfinal/'+e.target.getAttribute('href').slice(-4),
  ...
  $("#imgInp").change(function() {
    ...
    $('#familias > tbody').on('dblclick', '>tr', function () {
        ...
        $.ajax({
          type: 'ajax',
            url : '/codeigniter3/mejoras/get_general_data/'+idCodigo,
            ...
            success:function(data) {
                ...
                for(i=0; i<data.length; i++){
                       ...
                       $("input[name='AC_CODIGO_MODELO']").val(data[i]['MODELO']);
                       $("input[name='AC_CODIGO_SERIE']").val(data[i]['SERIE']);
                       $("input[name='AC_CODIGO_ESTADO']").val(data[i]['ESTADO']);

                       $("input[name='AC_CODIGO_FICHA']").val(data[i]['FICHA']);
                       
                       $("input[name='AC_CODIGO_VALOR']").val(data[i]['VALOR.LIBRO']);
                       $("input[name='AC_CODIGO_FECHA']").val(data[i]['FECHA.ADQ']);
                       $("input[name='AC_CODIGO_DEPRECIACION']").val(data[i]['DEPREC.ACUMULADA']);
                       $("input[name='AC_CODIGO_CUENTA']").val(data[i]['CUENTACONTABLE']);
                       $("input[name='AC_CODIGO_VR']").val(data[i]['VALOR.RESIDUAL']);
                       $("input[name='AC_CODIGO_MONEDA']").val(data[i]['MONEDA']);
    ...
    function buscarfamilias(){
             ...
             var b =$('#jobsearchfamilias').val()  ;
              ...
              $.ajax({
                type: 'ajax',
                  url : '/codeigniter3/mejoras/get_familia_data/'+texto,
