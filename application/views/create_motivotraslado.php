<form action="<?= base_url('motivotraslado/store') ?>" method="POST">
	<h4>Motivo de Traslado Nuevo</h4>
	<hr>
	<div class="form-group">
            <div class="form-row">
        		<div class="col-7">
        			<label for="">Descripcion</label>
        			<input type="text" name="MT_DESCRIPCION" class="form-control" placeholder="Nombre de motivo traslado" value="<?= set_value('user') ?>">
