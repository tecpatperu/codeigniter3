...
<h3 class="text-center">Edificios</h3>
    <div class="row form-inline">
        <a href="<?=base_url('edificios/')?>nuevo" class="btn btn-info btn-sm" role="button" >Nuevo</a>
      ...
      <table class="table w-auto small" >
        ...
        <tbody>
          ...
          <tr>
            ...
            <td >
                <a class="btn btn-warning btn-sm" href="<?=base_url('edificios/editar/'.$item->SE_ID)?>" role="button">Editar</a>  <a class="btn btn-danger btn-sm" href="#" data-id="<?=$item->SE_ID?>" id="delete" role="button">Eliminar</a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
