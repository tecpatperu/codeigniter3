<form action="<?= base_url('edificio/store') ?>" method="POST">
	<h4>Edificio Nuevo</h4>
	<hr>
	<div class="form-group">
            <div class="form-row">
        		<div class="col-7">
        			<label for="">Descripcion</label>
        			<input type="text" name="SE_DESCRIPCION" class="form-control" placeholder="Nombre de edificio" value="<?= set_value('user') ?>">
    ...
    <div class="form-group">     
        	<div class="form-row">
        		<div class="col-7">
        			...
        			<input name="SE_ABREVIATURA" class="form-control" type="text" placeholder="Abreviatura" value="<?= set_value('name') ?>">
