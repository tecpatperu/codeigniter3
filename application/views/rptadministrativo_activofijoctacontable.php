...
<form method="post"  action="<?php echo base_url(); ?>excel_export/action">
      <table class="table w-auto small" >
        ...
        <div > 
          ...
          <h3 style="background: blue;height:auto;width:auto;" class="text-center">Rep. Activos por cuenta contable</h3>  
           </div>
         <br>
        ...
        <div style="border: 1px solid #000; display:block; width:900px;" >
            <h5 style="background: #fff; margin-top: -10px; margin-left: 10px; padding: 0 10px; width: 220px;">Rango de Cuentas Contables</h5>
  ...
  <div class="row">
    <div class="col-sm-4">
    <div   >
    <!-- style="border: 1px solid #000; display:inline-block; width:510px; "-->
           <h5 style="background: #fff; margin-top: -10px; margin-left: 10px; padding: 0 10px; width: 150px;">Ordenar por</h5>
           <input type="radio" id="detallado" name="ordenar" value="detallado" checked = true > 
          <label for="detallado">Detallado</label> <br>
   ...
   <div class="col-sm-4">
   <br>
   <input type="radio" id="resumido" name="ordenar" value="resumido" >
