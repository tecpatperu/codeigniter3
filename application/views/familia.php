...
<h3 class="text-center">Familias</h3>
    <div class="row form-inline">
        <a href="<?=base_url('familias/')?>nuevo" class="btn btn-info btn-sm" role="button" >Nuevo</a>
      ...
      <table class="table w-auto small" >
        ...
        <tbody>
          ...
          <tr>
            ...
            <td >
                <a class="btn btn-warning btn-sm" href="<?=base_url('familias/editar/'.$item->Codigo)?>" role="button">Editar</a> <a class="btn btn-danger btn-sm" href="#" data-id="<?=$item->Codigo?>" id="delete" role="button">Eliminar</a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
